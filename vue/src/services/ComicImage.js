...
const API_KEY = "YAIzaSyDFAdCTAGq1vi3ZMWCRHlGwVZy7kku3dP4";
...
fetch(`https://www.googleapis.com/customsearch/v1?key=${"YAIzaSyDFAdCTAGq1vi3ZMWCRHlGwVZy7kku3dP4"}&cx=${"f78fb5a442a184e6d"}&q=${"Spiderman volume 1"}&searchType=image`)
